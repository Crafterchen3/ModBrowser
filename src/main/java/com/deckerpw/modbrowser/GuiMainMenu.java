...
public class GuiMainMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 100, j + 72 + (12 + 20), 98, 20, I18n.format("menu.options")));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 2, j + 72 + (12 + 20), 98, 20, I18n.format("menu.quit")));
        this.buttonList.add(new GuiButtonLanguage(5, this.width / 2 - 124, j + 72 + (12 + 20)));
        ...
        modUpdateNotification = net.minecraftforge.client.gui.NotificationModUpdateScreen.init(new net.minecraft.client.gui.GuiMainMenu(), modButton);
    }
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_)
    {
        ...
        this.buttonList.add(new GuiButton(20, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 3, "Get Mods!"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.splashText = net.minecraftforge.client.ForgeHooksClient.renderMainMenu(new net.minecraft.client.gui.GuiMainMenu(), this.fontRenderer, this.width, this.height, this.splashText);
